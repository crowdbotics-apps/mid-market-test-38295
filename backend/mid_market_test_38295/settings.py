"""
Django settings for mid_market_test_38295 project.
...
ROOT_URLCONF = 'mid_market_test_38295.urls'
...
WSGI_APPLICATION = 'mid_market_test_38295.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "mid_market_test_38295 API",
    "DESCRIPTION": "API documentation for mid_market_test_38295 App",
    "VERSION": "v1",
}
